# Импортируем необходимые для реализации библиотеки
import copy
import pickle
import base64
...
class General(object):
    ...
    def assignment_attempt(self, source) -> object:
        # Попытка присваивания: возвращает source, если он совместим с типом self, иначе None.
...
class Any(General):
    def assignment_attempt(self, source) -> object:
        #Попытка присваивания для Any: разрешает любой объект.
        return source
