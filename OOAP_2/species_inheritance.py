...
#В примере несколько равноправных классификаций:
#среда обитания, способ размножения.
#Они образуют независимые иерархии (Habitat и Reproduction).
#Конкретный объект Plant содержит обе характеристики,
# и их можно свободно комбинировать.
