...
# Assert`ы добавил в функции для проверки отрицательного урона, стоимости и здоровья
# Логирование добавил в функции в виде info, чтобы не выводилось в консоль
import logging
